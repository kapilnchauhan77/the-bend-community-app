...
def upgrade():
    ...
    op.create_index("uq_reports_reporter_target", "reports", ["tenant_id", "reporter_id", "target_type", "target_id"], unique=True, postgresql_where=sa.text("status = 'open'"))
...
def downgrade():
    ...
    op.execute("DROP INDEX IF EXISTS uq_reports_reporter_target")
