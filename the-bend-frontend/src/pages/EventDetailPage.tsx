...
export function EventDetailPage() {
  ...
  const isCurrentSuccess = state.status === 'success' && parseCanonicalUuid(state.event.id) === canonicalEventId;
