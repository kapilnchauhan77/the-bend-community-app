...
export function NativeRoutes() {
  return <Routes><Route element={<NativeAppShell />}>
    ...
    <Route path="/browse" element={focused('Browse', '/explore', <BrowsePage />)} /><Route path="/listing/:id" element={focused('Listing', '/explore?type=listings', <ListingDetailPage />)} /><Route path="/business/:shopId" element={focused('Business', '/explore?type=businesses', <BusinessProfilePage />)} /><Route path="/events" element={focused('Events', '/explore?type=events', <EventsPage />)} /><Route path="/events/:eventId" element={focused('Event', '/events', <EventDetailPage />)} /><Route path="/volunteers" element={focused('Volunteer', '/explore?type=volunteer', <VolunteerPage />)} /><Route path="/talent" element={focused('Talent', '/explore', <TalentPage />)} />
    <Route path="/login" element={<LoginPage />} /><Route path="/register" element={<RegisterPage />} /><Route path="/guidelines" element={focused('Community Guidelines', '/', <GuidelinesViewPage embeddedNative />)} /><Route path="/forgot-password" element={<ForgotPasswordPage />} /><Route path="/reset-password" element={<ResetPasswordPage />} />
