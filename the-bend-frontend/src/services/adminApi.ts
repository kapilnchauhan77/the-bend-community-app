...
export const adminApi = {
  ...
  listIndividuals: (params?: Record<string, string>) => api.get('/admin/individuals', { params }),
  suspendIndividual: (id: string, reason: string) => api.post(`/admin/individuals/${id}/suspend`, { reason }),
  reactivateIndividual: (id: string) => api.post(`/admin/individuals/${id}/reactivate`),
